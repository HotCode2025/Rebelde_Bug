...
# vamos a ver un método de ordenamiento que el python se ha convertido en una función
# por default ordena los elementos de manera ascendente
lista3.sort() # ordena de forma ascendente
print(lista3)
# podemos ordenarlos de manera descendente
